export const portfolioContent = {
  hero: {
    ...
    description:
      "Practical systems and frameworks for real estate ownership, strategic investing, and long-term growth.",
    ctaPrimary: "Join the Ownership Network",
  ...
  about: {
    ...
    stats: [
      ...
      { value: "4+", label: "Active Projects and Initiatives" },
    ],
  },
  ownership: {
    intro: [
  ...
  projects: [
    {
      ...
      description:
        "Short-form notes that break down practical real estate ownership lessons.",
      image:
    ...
    },
    {
      ...
      description:
        "Stories and wins from members building structure and discipline.",
      image:
    ...
    },
    {
      ...
      description:
        "Talks and sessions focused on ownership systems and wealth architecture.",
      image:
        "https://images.unsplash.com/photo-1475721027785-f74eccf877e2?q=80&w=1400&auto=format&fit=crop",
    },
  ],
  career: {
    title: "A Career That Can Fit Your Life",
    bullets: [
      "Licensed realtors",
